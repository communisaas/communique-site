    ...
    const aiSuggestionsData = [
      {
        ...
        suggestion: 'As a parent of two school-age children, I see firsthand how housing costs affect our teachers and our schools.',
        confidence: 0.85,
        context: {
          user_context: 'parent',
      ...
      },
      {
        ...
        user_id: null,
        variable_name: 'Personal Connection',
        suggestion: 'As a teacher who commutes 90 minutes each day, I understand the real cost of the housing crisis on education.',
        confidence: 0.92,
        context: {
    ...
    const personalizationData = [
      {
        ...
        template_id: templates[0].id,
        variable_name: 'Personal Connection',
        custom_value: 'As a teacher in this district for over 15 years, I have seen the housing crisis directly impact our ability to retain quality educators.',
        usage_count: 3
      },
      {
        user_id: users[0].id,
      ...
      },
      {
        ...
        variable_name: 'Personal Connection',
        custom_value: 'As a parent who struggles to afford rent despite working full-time, I understand how impossible it has become for families.',
        usage_count: 1
      }
    ];
