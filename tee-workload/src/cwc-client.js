 ...
 */
export async function forwardToCWC({ message, recipient, templateId }) {
	...
	const endpoint =
		recipient.office === 'senate'
			? 'https://soapbox.senate.gov/api/submit'
			: 'https://forms.house.gov/api/submit';

	console.log('Forwarding to CWC API:', {
		endpoint,
