...
export function isAnalyticsExperimentMetricsCache(value: unknown): value is AnalyticsExperimentMetricsCache {
  return (
    typeof value === 'object' &&
    value !== null &&
...
export function getExperimentMetricsCache(jsonValue: Prisma.JsonValue): AnalyticsExperimentMetricsCache {
 ...
 */
export function safeJsonAccess<T>(
