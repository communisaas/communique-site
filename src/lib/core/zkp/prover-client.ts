...
/**
 * Browser-friendly proof inputs (single-tree architecture - LEGACY)
 * Maps to CircuitInputs from @voter-protocol/noir-prover
 *
 * @deprecated Use TwoTreeProofInputs for new implementations
 */
...
/**
 * Browser-friendly proof result (single-tree architecture - LEGACY)
 * Simplified from NoirProofResult for UI consumption
 *
 * @deprecated Use TwoTreeProofResult for new implementations
 */
