...
export function getVariableSuggestions(
  ...
  // Data variables
  if (contentLower.includes('data') || contentLower.includes('statistic') || contentLower.includes('fact')) {
    suggestions.push({
      variable: '{data_point}',
  ...
  if (contentLower.includes('urgent') || contentLower.includes('deadline') || contentLower.includes('vote')) {
    suggestions.push({
      variable: '{deadline}',
      label: 'Deadline/Date',
...
function calculateEmotionalImpact(content: string): number {
  const emotionalWords = [
    'urgent', 'critical', 'important', 'crucial', 'vital',
    'please', 'help', 'need', 'must', 'essential',
    'family', 'children', 'future', 'community', 'together',
    'hope', 'believe', 'dream', 'fight', 'stand'
  ];
...
function calculateCallToActionStrength(content: string): number {
  const actionWords = [
    'please', 'urge', 'ask', 'request', 'support', 'vote',
    'contact', 'call', 'write', 'email', 'visit', 'help',
    'join', 'stand', 'act', 'demand', 'insist'
  ];
...
const commonWords = [
  ...
  'being', 'between', 'during', 'every', 'having', 'other',
  'should', 'since', 'their', 'there', 'these', 'those',
