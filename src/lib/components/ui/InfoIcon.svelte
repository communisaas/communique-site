...
<span class="relative inline-flex items-center">
	<button
		bind:this={iconRef}
		type="button"
		class="inline-flex items-center justify-center w-4 h-4 ml-1 text-slate-400 hover:text-slate-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 rounded-full"
	...
	{#if showTooltip}
		...
		>
			<div
				class="bg-slate-800 text-white text-xs rounded-lg px-3 py-2 shadow-lg"
			>
				{tooltip}
				<!-- Arrow -->
				<div
