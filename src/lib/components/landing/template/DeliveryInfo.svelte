<script lang="ts">
	...
	const deliveryTypes = {
		certified: {
			...
			MetricIcon: MapPin,
			metricValue: template.metrics.districts
		},
		direct: {
			icon: AtSign,
			...
			metricValue: template.metrics.reach
		}
	};
...
<div class="mb-4 rounded-lg border border-slate-200 bg-slate-50 p-3 md:mb-6 md:p-4">
