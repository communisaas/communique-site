...
<div class="min-h-screen bg-zinc-950 text-zinc-100">
	<div class="mx-auto max-w-4xl px-4 py-8">
		...
		<div class="mb-8 flex items-center justify-between">
			<h1 class="text-2xl font-bold text-zinc-100">SMS Campaigns</h1>
			<a
		...
		{#if data.blasts.length === 0}
			<div class="rounded-lg border border-zinc-800/60 py-16 text-center">
				<p class="text-lg text-zinc-400">No SMS campaigns yet.</p>
				<p class="mt-1 text-sm text-zinc-500">Send your first SMS campaign to reach supporters directly.</p>
				<a
					href="/org/{data.org.slug}/sms/new"
