...
<div class="min-h-screen bg-zinc-950 text-zinc-100">
	<div class="mx-auto max-w-4xl px-4 py-8">
		...
		<div class="mb-8 flex items-center justify-between">
			<h1 class="text-2xl font-bold text-zinc-100">Networks</h1>
			{#if data.canCreate}
				<a
		...
		{#if pendingNetworks.length > 0}
			<div class="mb-8">
				<h2 class="mb-3 text-sm font-medium text-zinc-400">Pending Invitations</h2>
				<div class="space-y-3">
							...
							<div class="flex items-start justify-between gap-4">
								<div class="min-w-0 flex-1">
									...
									{#if network.description}
										<p class="text-sm text-zinc-400">{network.description}</p>
									{/if}
		...
		{#if activeNetworks.length > 0}
			<div>
				<h2 class="mb-3 text-sm font-medium text-zinc-400">Your Networks</h2>
				<div class="space-y-3">
		...
		{:else if pendingNetworks.length === 0}
			<div class="rounded-lg border border-zinc-800/60 py-16 text-center">
				<p class="text-lg text-zinc-400">No networks yet.</p>
