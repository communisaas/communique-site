 ...
 *
 * Coordinate-based district resolution endpoint (dual-path architecture).
 * Accepts lat/lng coordinates, resolves congressional district and officials.
 *
 * PRIVACY CONSTRAINTS:
...
const resolveSchema = z.object({
	...
	cell_id: z.string().regex(/^\d{15}$/).optional(),
